...
const Collection = () => {
  ...
  const handleBack = () => {
    router.back(); // or replace with router.push('/(dashboard)/camera') if you want it hardcoded
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <Image
        source={require('../../assets/laundry-icon.png')}
        style={styles.image}
      />
      <Text style={styles.heading}>Collect Laundry</Text>
      <Text style={styles.machineId}>
        Machine: <Text style={styles.machineHighlight}>{machineId}</Text>
      </Text>
      <Text style={styles.instruction}>
        Please ensure you've collected all your laundry before confirming.
      </Text>
